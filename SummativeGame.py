...
while whereInGame == 1:
    ...
    if "yes" in firstCAnswer.lower() or "ok" in firstCAnswer.lower() or "sure" in firstCAnswer.lower():
        firstRight = input("\nAlright then, let's go to the school!  ")   
        whereInGame = 2
    else: 
        print("What? Please restart?")
        whereInGame = 1
...
while whereInGame ==3 and dayCounter<3:
    ...
    if currentLocation ==1:
        ...
        if "rid" in WhereToGoFromRiddle.lower():
    ...
    if currentLocation == 2:
        ...
        if "brav" in WhereToGoFromBravery.lower():
            ...
            if braveryPoints ==2 and currentLocation==2:
                ...
                if "lie" or "dead" in braveryAsk.lower()and currentLocation == 2:  
    ...
    if currentLocation == 3:
        ...
        if "luck" in WhereToGoFromLuck.lower():
